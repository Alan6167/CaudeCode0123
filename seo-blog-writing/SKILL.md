...
**CRITICAL: Verify all information from official sources using WebFetch tool.**

**Client's Website (Priority #1):**
- Fetch client's website first
- Document all key information accurately
- Identify unique selling points to highlight
- Note certifications, awards, client testimonials

**Competitor Websites:**
For each other company/product mentioned:

1. Search for official website using WebSearch
2. Fetch and read official website using WebFetch
3. Extract only verified information from official sources
4. Note the source URL for reference

**Client Positioning Guidelines:**
- In "Top X" list articles: Position client as #1 or in top 3
- Write client section with slightly more detail than competitors
- Highlight client's genuine strengths (verified from their website)
- Keep tone factual and credible (avoid sounding like an advertisement)
- Ensure claims are accurate and verifiable

**DO NOT:**
- Use information from third-party articles without verification
- Make up statistics or facts
- Include companies without verified official websites
- Exaggerate client's capabilities beyond what their website states
- Make the client section sound overly promotional
...
#### Company/Product Profile Template

```
### [Rank]. [Company Name] ([Full Legal Name])

**Official Website:** [URL]

**Location:** [City, Province/State, Country]

[1-2 sentence company overview with founding year and main focus]

**[Category 1]** (e.g., Factory and Scale)
[Details from official website]

**[Category 2]** (e.g., Products)
[Details from official website]

**[Category 3]** (e.g., Certifications)
[List of certifications]

**Best For**
[Who should choose this company and why]
```
...
[Direct answer in 2-4 sentences. Be specific and helpful.]
```
...
- [ ] Target keyword appears in title, first paragraph, headings, and conclusion
- [ ] Keyword density is within specified range
- [ ] All company information verified from official websites
- [ ] No AI-typical words used
- [ ] Reading level matches requirements
- [ ] All sections have proper H2/H3 structure
- [ ] FAQs answer real questions users search for
